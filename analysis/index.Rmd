...
cat("Today's Multiple Mayer's index is: ", index_summary$index[nrow(index_summary)],"\n",
    "Price = ", bitcoin_2023[bitcoin_2023$timestamp == Sys.Date(), "close"],"\n",
    "The decision is: ", index_summary$decision[nrow(index_summary)], "\n")
...
plot_data <- index_summary[1:1600,]
